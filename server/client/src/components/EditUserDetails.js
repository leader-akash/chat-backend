...
const EditUserDetails = ({ onClose, user }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Use the safeStringify utility to handle circular references
            const response = await axios.post(URL, safeStringify(data), {
            ...
            taost.error(error.response?.data?.message || 'An error occurred');
        }
    };
